 ...
 * @author diego
 */
public class EmployessListFrame extends javax.swing.JFrame {

    public EmployessListFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Data de admissão", "Valor do Salário", "Status", "Actions"
            }
        ) {
    ...
    private void addEmployeesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addEmployeesActionPerformed
        EmplyessCreateFrame emplyessCreateFrame = new EmplyessCreateFrame();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployessListFrame().setVisible(true);
            }
        });
    }
